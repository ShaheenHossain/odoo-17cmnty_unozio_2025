...
class TestThemeViews(common.TransactionCase):
    def test_inherit_specific(self):
        ...
        new_arch = '<xpath expr="//body" position="replace"><span>Unozio Change01</span></xpath>'
        ...
        new_arch = '<xpath expr="//body" position="replace"><span>Unozio Change02</span></xpath>'
        theme_view.arch = new_arch
        test_theme_module.with_context(load_all_views=True)._theme_load(website_1)
        ...
        new_arch = '<xpath expr="//body" position="replace"><span>Unozio</span></xpath>'
