...
class TestSnippets(HttpCase):
    ...
    def test_05_social_media(self):
        self.env.ref('website.default_website').write({
            ...
            'social_linkedin': 'https://www.linkedin.com/company/Unozio',
            'social_youtube': 'https://www.youtube.com/user/Unozio',
            'social_github': 'https://github.com/Unozio',
            'social_instagram': 'https://www.instagram.com/explore/tags/Unozio/',
            'social_tiktok': 'https://www.tiktok.com/@Unozio',
        })
