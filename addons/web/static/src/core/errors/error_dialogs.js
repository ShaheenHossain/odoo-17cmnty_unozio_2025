...
ErrorDialog.title = _t("Unozio Error");
...
ClientErrorDialog.title = _t("Unozio Client Error");

// -----------------------------------------------------------------------------
// Network Error Dialog
// -----------------------------------------------------------------------------
export class NetworkErrorDialog extends ErrorDialog {}
NetworkErrorDialog.title = _t("Unozio Network Error");
...
export class RPCErrorDialog extends ErrorDialog {
    ...
    inferTitle() {
        ...
        switch (this.props.type) {
            case "server":
                this.title = _t("Unozio Server Error");
                break;
            case "script":
                this.title = _t("Unozio Client Error");
                break;
            case "network":
                this.title = _t("Unozio Network Error");
                break;
        }
    }
...
export class WarningDialog extends Component {
    ...
    inferTitle() {
        ...
        return this.props.title || _t("Unozio Warning");
    }
}
...
export class RedirectWarningDialog extends Component {
    setup() {
        ...
        this.title = capitalize(subType) || _t("Unozio Warning");
        this.message = message;
...
SessionExpiredDialog.title = _t("Unozio Session Expired");
