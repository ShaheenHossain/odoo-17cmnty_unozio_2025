...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("OdooBeforeTestHook", "OdooAfterTestHook"); // Unozio customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("OdooBeforeTestHook"); // Unozio customization
